...
void main() {
  ...
  test('cobre o primário inteiro, e o primeiro degrau do secundário', () {
    ...
    expect(classes, {
      ...
      '8ª classe',
      // A 9ª fecha o 1º ciclo do secundário. Sem TIC: o programa das TIC
      // é só de 7ª e 8ª.
      '9ª classe',
    });
  });
  ...
  test('o corpus de perguntas não encolhe sem se dar por isso', () {
    ...
    //  1800  com o Português da 8ª classe (75)
    //  1858  com a Geografia da 8ª classe (58)
    ...
    //  2195  com o Inglês da 8ª classe (73)
    //  2249  com o Francês da 8ª classe (54)
    //  2309  com a Educação Visual da 8ª classe (60)
    //  2355  com a Educação Física da 8ª classe (46)
    //  2411  com a Agropecuária da 8ª classe (56)
    //  2462  com as TIC da 8ª classe (51)
    //  2568  com a Matemática da 9ª classe (106)
    //  2643  com o Português da 9ª classe (75)
    //  2718  com a Geografia da 9ª classe (75)
    //  2783  com a História da 9ª classe (65)
    //  2858  com a Biologia da 9ª classe (75)
    //  2935  com a Física da 9ª classe (77)
    //  3010  com a Química da 9ª classe (75)
    //  3080  com o Inglês da 9ª classe (70)
    //  3125  com o Francês da 9ª classe (45)
    //  3175  com a Educação Visual da 9ª classe (50)
    //  3220  com a Educação Física da 9ª classe (45)
